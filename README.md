...
|------|-----:|------:|----------------:|------------------:|
| **bounce** | **340,774,681** | **72.2%** | **56.3 MB/s** | **450.8 MB/s** |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 408,985 | 29.6% | 20.7 MB/s | 30.5 MB/s |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 98,706 | 18.6% | 7.8 MB/s | 11.8 MB/s |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 1,062,785,349 | 99.0% | 74.3 MB/s | 143.2 MB/s |
