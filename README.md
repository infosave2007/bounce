...
|------|-----:|------:|----------------:|------------------:|
| **bounce** | **340,774,681** | **72.2%** | **55.4 MB/s** | **452.3 MB/s** |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 408,985 | 29.6% | 21.6 MB/s | 30.0 MB/s |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 98,706 | 18.6% | 8.6 MB/s | 11.7 MB/s |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 1,062,785,349 | 99.0% | 75.3 MB/s | 148.3 MB/s |
