...
|------|-----:|------:|----------------:|------------------:|
| **bounce** | **343,255,057** | **72.7%** | **124.4 MB/s** | **672.4 MB/s** |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 461,930 | 33.4% | 3.7 MB/s | 37.1 MB/s |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 98,652 | 18.6% | 8.1 MB/s | 14.5 MB/s |
...
| Tool | Size | Ratio | C (Compression) | D (Decompression) |
|------|-----:|------:|----------------:|------------------:|
| **bounce** | 1,065,272,889 | 99.2% | 163.1 MB/s | 834.2 MB/s |
